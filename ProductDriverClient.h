...
public:
  ...
  void DriverBootup(void)
  {
    ...
    {{
      ...
      {{0x0F, 0x88, 0x74, 0x45, 0x73, 0xFB, 0x29, 0x77, 0x8B, 0xBB, 0x8E, 0x68, 0x7F, 0x3E, 0xCE, 0x2C}},
      {{0x14, 0x92, 0x26, 0xA2, 0x6B, 0x71, 0x7E, 0x6D, 0xD9, 0x5E, 0x92, 0x33, 0x4E, 0x41, 0x2D, 0x9A}},
      {{0x19, 0xB8, 0xEE, 0x2B, 0x61, 0xA8, 0x80, 0x47, 0x11, 0xD5, 0xA8, 0x6C, 0x79, 0x3A, 0xF5, 0x83}},
    ...
    static uint16_t array_set[3]={0x37,0x7D,0xE8};
